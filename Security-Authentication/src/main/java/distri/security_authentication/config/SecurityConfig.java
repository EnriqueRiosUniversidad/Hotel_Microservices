...
import org.springframework.web.cors.UrlBasedCorsConfigurationSource;  // Esta es la clase que define el origen CORS
...
/*    @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Collections.singletonList("*")); // Permitir cualquier origen
        //configuration.setAllowedOrigins(Arrays.asList("http://localhost:5173", "http://localhost:8080"));
        configuration.setAllowedMethods(Arrays.asList("GET", "POST", "PUT", "DELETE", "OPTIONS"));
        configuration.setAllowedHeaders(Collections.singletonList("*")); // Permitir cualquier encabezado
